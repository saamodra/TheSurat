...
INSERT INTO `bagian` (`bagian_id`, `bagian`, `keterangan`) VALUES (2,'Personalia','Personalia'),(3,'Sekretaris','Sekretaris'),(4,'Admin','Admin'),(5,'Keamanan','Keamanan'),(7,'Tata Usaha','Tata Usaha');
...
INSERT INTO `block_ip` (`blockip_id`, `ip`, `keterangan`) VALUES (44,'192.122.8.134','Lenovo');
...
INSERT INTO `identitas` (`identitas_id`, `nama_identitas`, `alamat`, `kota`, `telp`, `website`, `pemilik`, `keuangan`, `logo_kiri`, `logo_kanan`) VALUES (1,'SMK Negeri 1 Jenangan','Jl. Niken Gandini No. 98 Setono Jenangan','Ponorogo','352481236','www.smkn1jenpo.sch.id','unknown','Bank','logo.smk.jenangan.png','logo.smk.jenangan.png'),(2,'SMKN 1 Jenangan','Jl. Niken Gandini No. 98, Setono, Jenangan','Ponorogo','0352481236','www.smkn1jenpo.sch.id','-','-','logo.smk.jenangan.png','logo.smk.jenangan.png');
...
INSERT INTO `jenis` (`jenis_id`, `jenis`, `keterangan`) VALUES (1,'Surat Dinas2','Surat Dinas2'),(2,'Surat Rahasia','Surat Rahasia'),(3,'Surat Pribadi','Surat Pribadi'),(4,'Surat Resmi','Surat Resmi'),(5,'dsasda','dsaads');
...
INSERT INTO `lokasi` (`lokasi_id`, `lokasi`, `keterangan`) VALUES (1,'Rak-01','Atas'),(2,'Rak-01','Tengah'),(3,'Rak-01','Bawah'),(5,'Rak-02','Tengah'),(7,'Rak-03','Atas');
...
INSERT INTO `user` (`user_id`, `password`, `level`, `nama`) VALUES ('admin','21232f297a57a5a743894a0e4a801fc3','Admin','Admin'),('admin@gmail.com','21232f297a57a5a743894a0e4a801fc3','Admin','Admin'),('iankco46@gmail.com','3edcdf9f179e44e582f70b096d23b6f9','User','Muh. Hardiansah'),('muhammadadimas20@gmail.com','db087f8b9ebba7f63c2d565f9e192388','User','Adimas'),('samodra30@gmail.com','cd9b0ae1c519840af84220f2222e11c3','Admin','Samodra'),('szsamodra@gmail.com','Shinigami12','Admin','Shinigami'),('user','user','User','User');
...
-- Dump completed on 2018-05-14  6:43:33
