...
INSERT INTO `bagian` (`bagian_id`, `bagian`, `keterangan`) VALUES (2,'Personalia','Personalia'),(3,'Sekretaris','Sekretaris'),(4,'Admin','Admin'),(5,'Keamananq122','Keamanan'),(24,'sasdas','asdasdsad'),(25,'adss','dsaasd'),(26,'sdaassad','asadsdsa'),(27,'asdasdads','asdasdsad'),(28,'Backup','Buka Halaman Backup'),(30,'Backup2','Buka Halaman Backup'),(31,'Backup2','Buka Halaman Backup'),(32,'Backup2','Buka Halaman Backup');
...
INSERT INTO `block_ip` (`blockip_id`, `ip`, `keterangan`) VALUES (44,'192.122.8.134','Lenovo'),(45,'168.83.127.4','Test');
...
INSERT INTO `identitas` (`identitas_id`, `nama_identitas`, `alamat`, `kota`, `telp`, `website`, `pemilik`, `keuangan`, `logo_kiri`, `logo_kanan`) VALUES (1,'SMK Negeri 1 Jenangan','Jl. Niken Gandini No. 98, Setono, Jenangan','Ponorogo','352481236','www.smkn1jenpo.sch.id','-','Bank Aldana','logo.smk.jenangan.png','logo.smk.jenangan.png'),(2,'SMKN 1 Jenangan','Jl. Niken Gandini No. 98, Setono, Jenangan','Ponorogo','0352481236','www.smkn1jenpo.sch.id','-','-','logo.smk.jenangan.png','logo.smk.jenangan.png');
...
INSERT INTO `jenis` (`jenis_id`, `jenis`, `keterangan`) VALUES (1,'Surat Dinas2','Surat Dinas2'),(2,'Surat Rahasia','Surat Rahasia'),(3,'Surat Pribadi','Surat Pribadi'),(4,'Surat Resmi','Surat Resmi');
...
INSERT INTO `lokasi` (`lokasi_id`, `lokasi`, `keterangan`) VALUES (1,'Rak-01','Atas'),(2,'Rak-01','Tengah'),(3,'Rak-01','Bawah'),(5,'Rak-02','Tengah'),(7,'Rak-03','Atas'),(8,'Rak2','Atas');
...
INSERT INTO `surat_masuk` (`surat_masuk_id`, `nomor_surat`, `bagian_id`, `sifat`, `perihal`, `tanggal_surat`, `tanggal_terima`, `tanggal_expired`, `nomor_agenda`, `lampiran`, `disposisi`, `tembusan`, `instansi_id`, `jenis_id`, `tindak_lanjut`, `lokasi_id`, `user_id`, `waktu`) VALUES (15,'898913',2,'RAHASIA','jskhkash','2018-04-03','2018-04-11','2018-04-13','8989','1.oxps','-','-',1,2,'TIDAK PERLU TINDAK LANJUT',1,'admin',NULL),(16,'1223',2,'RAHASIA','sda','2018-04-05','2018-04-06','2018-04-13','123','Menu.docx','asa','ghjgh',3,2,'PERLU TINDAK LANJUT',3,'admin','2018-04-28 03:46:18'),(22,'789798',5,'BIASA','Keuangan','2018-04-07','2018-04-13','2018-04-20','21','surat lamaran.pdf','sadas','sahdkj',6,4,'PERLU TINDAK LANJUT',3,'admin','2018-05-02 11:54:45'),(23,'23231',3,'KONFIDENSIAL','sdsda','2018-05-12','2018-05-19','2018-05-24','213231','CSVFILE.csv','dsadsa','dsadsa',5,2,'TIDAK PERLU TINDAK LANJUT',1,'admin',NULL),(24,'2319',3,'KONFIDENSIAL','Rapat','2018-05-05','2018-05-06','2018-05-06','212','Manual Book.docx','-','-',3,2,'PERLU TINDAK LANJUT',3,'admin@gmail.com',NULL);
...
INSERT INTO `user` (`user_id`, `password`, `level`, `nama`, `profil`) VALUES ('admin','21232f297a57a5a743894a0e4a801fc3','Admin','Admin',''),('admin@gmail.com','21232f297a57a5a743894a0e4a801fc3','Admin','Admin','karawang_tuparev_wpap_by_jodiartz-dbtlu9b.jpg'),('iankco46@gmail.com','3edcdf9f179e44e582f70b096d23b6f9','User','Muh. Hardiansah',''),('muhammadadimas20@gmail.com','db087f8b9ebba7f63c2d565f9e192388','User','Adimas',''),('samodra30@gmail.com','cd9b0ae1c519840af84220f2222e11c3','Admin','Samodra',''),('szsamodra@gmail.com','Shinigami12','Admin','Shinigami',''),('user@gmail.com','ee11cbb19052e40b07aac0ca060c23ee','User','User','avatar04.png');
...
-- Dump completed on 2018-06-01  6:05:11
