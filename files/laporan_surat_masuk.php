...
write_log('Buka Halaman Laporan Surat Masuk ('.$id_user.')');
mysqli_query($con2, "insert into log(userid, menu, ip, log) values ('$id_user','Surat Masuk','$ip','Buka Halaman Laporan Surat Masuk ($id_user)')");
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-header">
					<h1 id="navbars">Laporan Surat Masuk	<small><small><small><small>Laporan Surat Masuk</small></small></small></small></h1>
				</div>
			</div>
		</div><br>
		<div class="row">
			<div class="col-lg-6">
				<form class="form-horizontal" method="get" action="index.php">
					<input type="hidden" name="file" value="laporan_surat_masuk">
					<table>
						<tr>
			...
			<div class="col-lg-6" align="right">
				<a href="index.php?file=excel_srt_masuk" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden></i> Export Excel</a>
				<a href="index.php?file=pdf_srt_masuk&cari=" class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden></i> PDF</a>
				<a href="index.php?file=print_all_srt_masuk&cari=" class="btn btn-info"><i class="fa fa-print" aria-hidden></i> Cetak</a>
			</div>
		</div><br>
		<div class="row">
				...
				<div>
					<ul class="pagination">
						...
						<li class="page-item active">
							...
							?>
						<li class="page-item">
							<a class="page-link" href="index.php?file=laporan_surat_masuk&cari1=<?php echo $cari1;?>&cari2=<?php echo $cari2;?>&hal=<?php echo $i;?>"><?php echo $i;?></a>
						</li>
						<?php
							} #_end IF
						}
